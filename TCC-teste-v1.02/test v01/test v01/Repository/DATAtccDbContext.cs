...
public partial class DATAtccDbContext : DbContext
{
    public DATAtccDbContext()
    {
    }

    public DATAtccDbContext(DbContextOptions<DATAtccDbContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=.\\SENAI;Initial Catalog=DATAtcc;Persist Security Info=True;User ID=sa;Password=senai.123;TrustServerCertificate=True");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Documento>(entity =>
        {
            entity.HasKey(e => e.Documentoid).HasName("PK__document__69A574B516749E6B");
            ...
            entity.HasMany(d => d.IdPalavraChaves).WithMany(p => p.IdDocumentos)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        j.HasKey("IdDocumento", "IdPalavraChave").HasName("PK__document__7AB466A687759598");
        ...
        {
            entity.HasKey(e => e.IdLocalizacao).HasName("PK__localiza__3EE0C96860943AA4");
        });

        modelBuilder.Entity<PalavraChave>(entity =>
        {
            entity.HasKey(e => e.IdPalavraChave).HasName("PK__palavra___79A8143301A520BA");
            ...
            entity.HasMany(d => d.IdLocalizacaos).WithMany(p => p.IdPalavraChaves)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        j.HasKey("IdPalavraChave", "IdLocalizacao").HasName("PK__palavra___EA4618A587D44885");
        ...
        {
            entity.HasKey(e => e.Idusuario).HasName("PK__usuario__080A97438A2D77FB");
